...
namespace drasil
{
    ...
    {
        return ((count ? hash(s, count - 1) : 2166136261u) ^ s[count]) *
    ...
    //     const EventId PACKET_RECEIVED =
    //     "Events::Network::PACKET_RECEIVED"_hash; const ParamId PACKET =
    //     "Events::Network::PACKET"_hash;
    // }
